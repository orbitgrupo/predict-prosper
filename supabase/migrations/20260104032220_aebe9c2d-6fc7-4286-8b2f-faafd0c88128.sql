-- Add validation to place_bet function to check option exists in market_options
...
BEGIN
  ...
  -- Validate that option exists for this market
  SELECT EXISTS (
  ...
  -- Update market_options total for this option
